<template>
  <div id="resumeForm">
    ...
    <div class="container">
        ...
        <education
          v-for="(education, index) in user.education" :key="education.id"
  ...
  export default {
    ...
    methods:{
      ...
      deleteEducation(education){
        ...
        this.user.education.splice(this.user.education.indexOf(education), 1);
      },
      addEdu(){
        ...
        console.log('education', this.user.education);
      },
      Enter (){
        this.errors=[];
        var flag=1;
